...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/DeepVikky88/Alivia",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/love_in_timeee")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/+gqYigWppV603NDJk")
